...
/// PRSTK ALPHA line when alpha_reg is empty: "ALPHA:                 " (ALPHA: + 17 spaces = 24).
#[test]
fn test_prstk_alpha_empty_line_format() {
    ...
    assert_eq!(
        alpha_line.as_str(),
        "ALPHA:                 ", // "ALPHA:" (6) + " " (1 label padding = 7 total) + 17 spaces = 24
        "PRSTK ALPHA line with empty alpha_reg must be 'ALPHA:' left-padded to 24"
    );
}
