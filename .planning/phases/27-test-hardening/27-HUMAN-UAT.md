...
updated: 2026-05-15T18:25:00Z
---

## Current Test

[awaiting manual branch-protection setting in GitHub repo Settings]
...
result: passed 2026-05-15T18:17:00Z (run 25927867511 / job 76215350335; observed after iterative fixes: MSRV→ci-msrv split, gui-build self-installing, wdio.conf.js→.cjs rename + hostname/port set + browserName removed + application path corrected, smoke spec uses browser.execute() to bypass WebKitGTK SVG interactability heuristic). PR #11 statusCheckRollup: 20/20 SUCCESS.
